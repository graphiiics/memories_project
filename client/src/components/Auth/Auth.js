...
const SignUp = () => {
    ...
    const clientId = '978168131609-raji7s2qaof81vo32a92ajfgnra3r15e.apps.googleusercontent.com';
    ...
    const googleError = (error) => {
         ...
         * New clients must use the new libraries instead; existing clients must 
         * also migrate before these libraries are deprecated. 
